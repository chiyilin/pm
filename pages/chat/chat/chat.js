  ...
  send: function() {
    ...
    if (this.data.message.trim() == "") {
      ...
      var sendData = {
        ...
        face: this.data.userinfo.face,
      }
      // '{ "content": "' + this.data.message + '", "date": "' + utils.formatTime(new Date()) + '","type":"text", "nickName": "' + this.data.userinfo.nickName + '", "avatarUrl": "' + this.data.userinfo.avatarUrl + '" }'
